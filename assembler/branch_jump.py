...
BRANCH_TYPE={"beq":("000","1100011"),"bne":("001","1100011"),"blt":("100","1100011"),"bge":("101","1100011"),"bltu":("110","1100011"),"bgeu":("111","1100011"),}
...
def encode_branch(instr, rs1, rs2, imm, REGISTER_MAP, to_signed_binary):
    ...
    imm_12=imm_binary[0]
    imm_10_5=imm_binary[2:8]
    imm_4_1=imm_binary[8:12]
    imm_11=imm_binary[1]
    binary=imm_12 + imm_10_5 + rs2_binary + rs1_binary + funct3 + imm_4_1 + imm_11 + opcode
    return binary
